...
⚠️ **htmx 4.x is stable but MUST NOT be used yet: a fetch-based rewrite with breaking
changes.** This baseline adopts it in a release of its own once 4.0.1 ships
